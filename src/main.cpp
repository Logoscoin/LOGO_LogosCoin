...
uint256 hashGenesisBlock("0x00000000cb2ce31faf006c862eeabc244c36147101fbb973ce005b5c2f44db33");
...
const string strMessageMagic = "LOGOSCOIN Signed Message:\n";
...
{
    int64 nSubsidy = 9500 * COIN;

    // Subsidy is cut in half every 32500 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 32500);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000cb2ce31faf006c862eeabc244c36147101fbb973ce005b5c2f44db33");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1413431309;
        block.nBits    = 486604799;
        block.nNonce   = 2751936100;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LOGOSCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LOGOSCOINMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running LOGOSCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("LOGOSCOINMiner terminated\n");
        throw;
    }
}
