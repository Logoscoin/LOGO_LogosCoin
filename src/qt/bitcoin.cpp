...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "LOGOSCOIN",
    ...
    QApplication::setOrganizationName("LOGOSCOIN");
    QApplication::setOrganizationDomain("logoscoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("LOGOSCOIN-Qt-testnet");
    else
        QApplication::setApplicationName("LOGOSCOIN-Qt");
